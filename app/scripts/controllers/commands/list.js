...
/**
 * @ngdoc function
 * @name dataduduR3App.controller:CommandsListCtrl
 * @description
 * # CommandsListCtrl
 * Controller of the dataduduR3App
 */
angular.module('dataduduR3App')
.controller('CommandsListCtrl', function ($scope, $timeout, $log, $route, command, Auth, modalConfirm, ngNotify) {
