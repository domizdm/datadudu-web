...
/**
 * @ngdoc function
 * @name dataduduR3App.controller:RulesListCtrl
 * @description
 * # RulesListCtrl
 * Controller of the dataduduR3App
 */
angular.module('dataduduR3App')
.controller('RulesListCtrl', function ($scope, $timeout, $log, $route, rule, Auth, modalConfirm, ngNotify) {
