...
.service('product', function ($resource, config) {
  return $resource(config.END_POINT+'/:controller/:_action/:item/:id/:_type/:type_id/:_extra_1', {
     ...
     * Update a Product Batch
     ...
     To view a product batch, send HTTP PUT to http://api.datadudu.cn/products/PRODUCT_ID replacing PRODUCT_ID
     ...
     * Delete a Product Batch
     ...
     To view a product batch, send HTTP DELETE to http://api.datadudu.cn/products/PRODUCT_ID replacing PRODUCT_ID
